...
graph TD
    ...
    Root --> KR[".kr TLD"]
    COM --> EXAMPLE["example.com Auth NS"]
    COM --> GOOGLE["google.com Auth NS"]
    EXAMPLE --> WWW["www.example.com→93.184.216.34"]
```
...
sequenceDiagram
    ...
    participant LR as LocalResolver
    participant Root as RootDNS
