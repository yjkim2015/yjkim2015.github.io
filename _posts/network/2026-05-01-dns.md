...
```mermaid
graph LR
    C["Client"] -->|"example.com?"| LR["Resolver"]
    LR -->|"example.com?"| AUTH["AuthDNS"]
    AUTH -->|"93.184.216.34"| LR
    LR -->|"93.184.216.34"| C
```
...
### Q. A 레코드와 CNAME의 차이는? 언제 각각을 쓰는가?
