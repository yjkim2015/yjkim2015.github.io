...
### Q2. TIME_WAIT가 왜 정확히 2MSL인가? 더 짧으면 안 되는가?
...
### Q3. Fast Retransmit에서 왜 3 Dup ACK를 기준으로 하는가? 1이나 2면 안 되는가?
...
### Q5. SYN Cookie의 한계와 QUIC의 0-RTT는 동일한 문제가 있는가?
