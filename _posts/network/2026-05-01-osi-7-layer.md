...
### Q. TCP의 3-way Handshake는 왜 2-way가 아닌가? SYN Flood는 어떻게 방어하는가?
...
### Q. TIME_WAIT이 서버 성능에 미치는 영향과 해결책은?
...
### Q. HTTP/2 멀티플렉싱이 TCP HOL Blocking을 해결하지 못하는 이유는?
...
### Q. 라우팅 알고리즘 Distance Vector와 Link State의 차이와 Count-to-Infinity 문제란?
...
### Q. 혼잡 제어 Slow Start → AIMD → Fast Recovery 흐름에서 Google BBR이 왜 등장했는가?
