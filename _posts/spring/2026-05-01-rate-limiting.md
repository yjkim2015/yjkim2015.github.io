...
```mermaid
sequenceDiagram
    윈도우1_마지막__59s->>경계_60s_기준_2초_안에: 호출
    윈도우2_시작__61s->>경계_60s_기준_2초_안에: 호출
```
...
```mermaid
sequenceDiagram
    이전_윈도우__0:59~1:00->>예상_요청_수_계산: 호출
    현재_윈도우__1:00~1:01->>예상_요청_수_계산: 호출
    현재_시각:_1:00:45->>예상_요청_수_계산: 호출
```
