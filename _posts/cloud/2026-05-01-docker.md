...
```mermaid
graph TD
    HW1["HW"] --> OS1["Host OS"] --> HV["Hypervisor"] --> VM1["VM1:GuestOS+App"] & VM2["VM2:GuestOS+App"]
    HW2["HW"] --> OS2["Host OS(커널공유)"] --> DE["Docker Engine"] --> C1["Container1:App+Libs"] & C2["Container2:App+Libs"]
```
