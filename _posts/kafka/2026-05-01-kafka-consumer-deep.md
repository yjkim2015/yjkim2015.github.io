...
sequenceDiagram
    ...
    P1->>order-group: 호출
    P2->>order-group: 호출
    P0->>analytics-group: 호출
    P1->>analytics-group: 호출
    P2->>analytics-group: 호출
```
...
```mermaid
sequenceDiagram
    ConsumerA/B->>Coordinator: JoinGroup
    ConsumerC->>Coordinator: JoinGroup
    Coordinator->>ConsumerA/B: SyncGroup 새 할당
```
