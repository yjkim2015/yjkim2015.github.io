...
graph LR
    ...
    Q -->|"Key 없음"| RR["2️⃣ 라운드 로빈"..|"Key 있음"| Hash["2️⃣ Key 해..|"커스텀"| Custom["2️⃣ 커스텀 파티셔너"]
...
```mermaid
graph LR
    Producer[Producer] -->|"1️⃣ 스키마 등록/확인"| SchemaRegistry[..|"1️⃣ 스키마 조회"| SchemaRegistry
..|"2️⃣ Avro/Protobuf"| Kafka[Kafka]
  ..|"3️⃣ Avro/Protobuf"| Consumer
