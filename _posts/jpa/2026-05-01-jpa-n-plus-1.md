...
```mermaid
graph LR
    Q1["SELECT * FROM Team"] -->|"기대: IN절 1번"| Q2["SELECT * FR..|"실제: N번"| R2["SELECT * FROM Memb"]
...
graph LR
    ...
    Q3{"성능 최우선?"}
    Q4{"복잡한 조건?"}
    Q1 -->|YES| A1["@BatchSize+..|NO| Q2
    Q2 -->|YES| A2["FetchJoin/@..|NO| Q3
...
graph LR
    ...
    Q3{"성능 최우선?"}
    S --> Q1
    Q1 -->|YES| A1["FetchJoin/@..|NO| Q2
    Q2 -->|YES| A2["@BatchSize+..|NO| Q3
```
