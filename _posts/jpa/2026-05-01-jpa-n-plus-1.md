...
```mermaid
graph TD
    Q1["SELECT * FROM Team"] -->|"기대: IN절 1번"| Q2["SELECT * FROM Member WHERE team_id IN(1..5)"]
    R1["SELECT * FROM Team"] -->|"실제: N번"| R2["SELECT * FROM Member WHERE team_id=1"]
...
graph TD
    ...
    Q1 -->|NO| Q2
    Q2 -->|YES| A2["FetchJoin/@EntityGraph"]
    Q2 -->|NO| Q3
    Q3 -->|YES| A3["QueryDSL+DTO"]
    Q3 -->|NO| Q4
    Q4 -->|YES| A4["QueryDSL+@BatchSize"]
```
...
graph TD
    ...
    Q3{"성능 최우선?"}
    S --> Q1
    Q1 -->|YES| A1["FetchJoin/@EntityGraph"]
    Q1 -->|NO| Q2
