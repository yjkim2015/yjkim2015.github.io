...
```mermaid
sequenceDiagram
    문서_도착->>Translog_WAL: 호출
    In-Memory_Buffer->>Segment1: refresh_1초
    In-Memory_Buffer->>Segment2: 호출
    Segment1->>합병_Segment: merge
    Segment2->>합병_Segment: merge
    Segment3->>합병_Segment: merge
```
