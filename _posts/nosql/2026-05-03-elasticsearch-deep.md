...
flowchart LR
    ...
    W --> TL["Translog(WAL)"]
    BUF -->|"refresh(1초)"| SEG1["Segment1"..|"merge"| MERGED["합병 Segment"]
```
...
```mermaid
flowchart LR
    Q1{"예상 데이터 크기?"} --> |"< 30GB"| S1["1 Primary +..|"30~150GB"| S3["3~5 Primary..|"150GB~1TB"| S10["5~20 Prima..|"> 1TB"| ILM["시계열 → ILM 롤오버"]
```
