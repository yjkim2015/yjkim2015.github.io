...
categories: SERVER
tags: [Nginx, ReverseProxy, LoadBalancing, SSL, WebServer, RateLimiting, epoll, EventLoop]
toc: true
toc_sticky: true
toc_label: 목차
date: 2026-05-01
...
## 8️⃣ Rate Limiting 동작원리 — Leaky Bucket 알고리즘
...
http {
    ...
    add_header X-XSS-Protection "1; mode=block";             # XSS 필터 강제
...
| Rate Limiting | Leaky Bucket 알고리즘 |
