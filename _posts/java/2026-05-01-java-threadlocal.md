...
### Q. ThreadLocal의 메모리 누수 원인을 설명하세요.
...
### Q. ThreadLocal.withInitial()의 사용 목적은?
...
### Q. ScopedValue와 ThreadLocal의 핵심 차이는?
...
### Q. Spring Security는 왜 ThreadLocal을 사용하나요?
...
### Q. ThreadLocal 메모리 누수의 정확한 메커니즘은?
...
### Q. Spring Security의 SecurityContextHolder가 ThreadLocal을 사용하는 이유는?
...
### Q. Virtual Thread 환경에서 ThreadLocal 사용의 문제점은?
...
### Q. InheritableThreadLocal의 동작과 주의사항은?
...
### Q. MDC(Mapped Diagnostic Context)와 ThreadLocal의 관계는?
