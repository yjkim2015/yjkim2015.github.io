...
### Q. 부모 위임 모델을 왜 사용하는가? 직접 하면 안 되나?
...
### Q. volatile은 어떻게 가시성을 보장하는가? synchronized와 차이는?
...
### Q. JIT 티어드 컴파일에서 C1과 C2의 역할 분담은?
...
### Q. PermGen이 Metaspace로 바뀐 이유와 Metaspace OOM은 어떻게 진단하는가?
...
### Q. 탈출 분석은 무엇이고, 왜 new가 항상 힙 할당이 아닐 수 있는가?
