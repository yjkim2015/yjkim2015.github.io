...
%%{init: {'theme': 'default', 'themeVariables': {'fontSize': '12px', 'nodePadding': '4px'}} }%%
graph LR
    IS["InputStream"] --> FIS["FileIS"] & BIS["BufferedIS"]
    OS["OutputStream"] --> FOS["FileOS"] & BOS["BufferedOS"]
```
...
%%{init: {'theme': 'default', 'themeVariables': {'fontSize': '12px', 'nodePadding': '4px'}} }%%
graph LR
    RD["Reader"] --> FR["FileReader"] & BR["BufferedReader"]
    WR["Writer"] --> FW["FileWriter"] & BW["BufferedWriter"]
```
...
%%{init: {'theme': 'default', 'themeVariables': {'fontSize': '12px', 'nodePadding': '4px'}} }%%
graph LR
    M1["FileInputStream"] --> M2["FileChannel"] --> M3["Files.copy(권장)"]
```
...
%%{init: {'theme': 'default', 'themeVariables': {'fontSize': '12px', 'nodePadding': '4px'}} }%%
graph LR
    IO["java.io"] --> BS["Stream"]
    NIO["java.nio"] --> CH["Channel"]
    NF["java.nio.file"] --> PF["Path/Files"]
    BS & CH & PF --> GUIDE["API 선택"]
```
