...
### Q. Static 중첩 클래스와 멤버 내부 클래스의 차이는?
...
### Q. Effective Java에서 "멤버 클래스는 되도록 static으로 만들라"고 하는 이유는?
...
### Q. Builder 패턴에서 Static 중첩 클래스를 사용하는 이유는?
```java
