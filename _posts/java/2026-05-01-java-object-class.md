...
### Q. equals()와 hashCode()를 함께 오버라이딩해야 하는 이유는?
...
### Q. toString()을 오버라이딩하지 않으면 어떤 문제가 생기는가?
...
### Q. wait()/notify()와 현대적 동기화 도구의 차이는?
...
### Q. Object.clone()을 사용할 때 주의해야 할 점은?
...
### Q. Object.wait()와 Thread.sleep()의 차이점은?
