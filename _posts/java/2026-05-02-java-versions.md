...
graph LR
    OS["OS 스레드 (1MB/개): 10"]
    CT1["Carrier Thread 1 ("] --> VT1["VT1 (KB)"] & VT2["VT2 (KB)"]
    CT2["Carrier Thread 2 ("] --> VT3["VT3 (KB)"] & VTN["VT-N (KB)"]
    NOTE["Virtual Thread: 10"]
    OS -.개선.-> CT1 & CT2
```
