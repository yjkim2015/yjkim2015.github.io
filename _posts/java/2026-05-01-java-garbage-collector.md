...
### Q. G1 GC와 ZGC의 구체적인 차이와 선택 기준은 무엇인가요?
...
### Q. Full GC가 발생하는 원인과 방지 방법은 무엇인가요?
...
### Q. 삼색 마킹(Tri-Color Marking)이 동시 GC에서 왜 필요한가요?
...
### Q. 약한 세대 가설이 틀리는 경우와 그 대처법은 무엇인가요?
...
### Q. OOM: GC Overhead Limit Exceeded는 왜 발생하며 어떻게 대응하나요?
