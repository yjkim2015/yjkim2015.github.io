...
> 비유: AI는 뛰어난 신입 개발자와 같다. 빠르게 코드를 작성하지만 맥락을 모르면 엉뚱한 방향으로 간다. 시니어 개발자(하네스 엔지니어)가 명확한 지시, 제약, 검증 체계를 갖춰줄 때 비로소 제 실력을 발휘한다.
...
<div class="mermaid">
graph TD
    A["1. 요구사항 분석 — 개발자"] --> B["2. 컨텍스트 준비\n관련 파일, 규칙 명시"]
    B --> C["3. AI에게 작업 지시 — 프롬프트"]
    C --> D["4. AI 출력 검토 — 개발자"]
    D --> E["5. 테스트/검증"]
    E -->|수정 필요| B
    E -->|완료| F["완료"]
