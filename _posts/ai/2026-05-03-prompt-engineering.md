...
```mermaid
graph LR
    TASK["작업 유형"] --> SIMPLE["단순 질의"]
    TASK --> COMPLEX["복잡 추론"]
    TASK --> MULTI["다단계 작업"]
    SIMPLE --> ZERO["Zero-shot"]
    COMPLEX --> COT["Chain-of-Thought"]
    MULTI --> AGENT["ReAct 에이전트"]
```
...
### Q. 프롬프트 엔지니어링에서 가장 중요한 원칙은 무엇인가요?
...
### Q. Chain-of-Thought이 효과적인 이유는 무엇인가요?
...
### Q. CLAUDE.md / 시스템 프롬프트를 어떻게 설계하나요?
