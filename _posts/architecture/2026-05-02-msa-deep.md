...
```mermaid
sequenceDiagram
    Closed_요청_통과->>Open_즉시_실패/Fallback: 연속 실패 5회
    Open_즉시_실패/Fallback->>HalfOpen_제한_허용: 30초 대기
    HalfOpen_제한_허용->>Closed_요청_통과: 테스트 성공
    HalfOpen_제한_허용->>Open_즉시_실패/Fallback: 테스트 실패
```
