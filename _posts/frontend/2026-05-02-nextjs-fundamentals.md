...
```mermaid
sequenceDiagram
    app/layout.tsx_루트->>blog/layout.tsx: 호출
    blog/layout.tsx->>blog/page.tsx_/blo: 호출
    app/layout.tsx_루트->>loading.tsx_/_erro: 호출
```
...
### Q. SSR, SSG, ISR, CSR의 차이와 각각 언제 사용하나요?
...
### Q. React Server Components(RSC)와 기존 SSR의 차이는?
...
### Q. Next.js App Router와 Pages Router의 주요 차이는?
...
### Q. Server Actions란 무엇이며 기존 API Route와 어떻게 다른가요?
