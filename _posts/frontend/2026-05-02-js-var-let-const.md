...
sequenceDiagram
    ...
    for_루프->>let_j_반복별: j_0=0,j_1=1,j_2=2
    let_j_반복별->>for_루프: 각각 0, 1, 2
```
...
flowchart LR
    ...
    B["var foo = function"] --> B1["var undefined 호이스팅"]
...
### Q. 호이스팅이 var와 let/const에서 다르게 동작하는 이유는?
...
### Q. TDZ(Temporal Dead Zone)란 무엇이며 왜 존재하나요?
...
### Q. for 루프에서 var와 let의 클로저 동작 차이를 설명하세요.
