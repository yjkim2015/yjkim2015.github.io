...
문자<br>&lt;html&gt; → 토큰<br>StartTag: ht, 토큰<br>StartTag: ht → 노드<br>HTMLElement<, 노드<br>HTMLElement< → DOM 트리
...
gantt title 브라우저 렌더링 타임라인 dateFormat X
...
mindmap root((렌더링 최적화)) CSS: 중요 CSS 인라인, 선택자 단순화
