...
### Q. `__proto__`와 `prototype`의 차이를 설명하세요.
...
### Q. ES6 클래스와 프로토타입 기반 생성자 함수의 실질적 차이는?
...
### Q. `Object.create(null)`을 언제 사용하나요?
...
### Q. 프로토타입 오염(Prototype Pollution) 공격이란?
