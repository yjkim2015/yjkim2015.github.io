...
graph LR
    subgraph "Buffer Pool"
        NY["New/Young Sublist<"]
        OLD["Old Sublist<br>신규"]
        OLD -->|"innodb_old_blocks_"| NY
    end
...
graph TD
    ...
    O --> E[실행엔진]
    E --> I[InnoDB]
    I --> BP["Buffer Pool (LRU 캐"]
    I --> WAL["WAL (Redo/Undo)"]
    BP --> BT["B+Tree 탐색<br>Clust"]
    WAL --> DW[Doublewrite Buffer]
    BT --> MVCC["MVCC<br>Undo Log 기"]
```
