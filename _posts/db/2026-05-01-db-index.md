...
```mermaid
graph LR
    R["Root:[40]"] --> I1["Internal:[20]"] & I2["Internal:[60]"]
    I1 --> L1["Leaf:[10,11]"] & L2["Leaf:[20,21]"] & L3["Leaf:[30,31]"]
    I2 --> L4["Leaf:[40,41]"] & L5["Leaf:[50,51]"] & L6["Leaf:[60,61]"]
    L1 -->|LinkedList| L2 --> L3 --> L4 --> L5 --> L6
```
