...
### 포인트 1: "왜 Kafka를 쓰나요? RabbitMQ나 SQS로는 안 되나요?"
...
### 포인트 2: "At-Least-Once와 Exactly-Once의 차이, 그리고 왜 At-Least-Once를 선택했는가?"
...
### 포인트 3: "1억 명에게 동시에 발송하는 캠페인을 어떻게 처리하는가?"
...
### 포인트 4: "Redis가 장애나면 중복 방지가 깨지는데 어떻게 대응하는가?"
...
### 포인트 5: "알림 시스템에서 가장 놓치기 쉬운 설계 실수는?"
