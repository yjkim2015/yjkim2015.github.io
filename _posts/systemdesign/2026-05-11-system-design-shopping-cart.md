...
### Q. Redis 장애 시 게스트 장바구니가 유실되어도 괜찮은가?
...
### Q. 병합 전략에서 수량 합산 vs 로그인 우선 중 어떤 것이 맞는가?
...
### Q. 결제 시 재고 Hard Lock의 데드락을 어떻게 방지하는가?
...
### Q. 장바구니 조회 QPS가 매우 높을 때 Product Service 호출을 어떻게 줄이는가?
...
### Q. 가격이 결제 직전에 인상됐을 때 사용자에게 어떻게 알리는가?
