...
### Q. LSM Tree가 B-Tree보다 쓰기 성능이 좋은 이유는?
...
### Q. Gossip Protocol은 어떻게 클러스터 상태를 전파하는가?
...
### Q. 데이터 파티셔닝 시 핫 파티션을 어떻게 감지하고 해결하는가?
...
### Q. 영속성 보장을 위해 WAL에서 fsync 빈도를 어떻게 설정하는가?
...
### Q. 분산 KV Store에서 트랜잭션(Multi-key ACID)을 어떻게 구현하는가?
