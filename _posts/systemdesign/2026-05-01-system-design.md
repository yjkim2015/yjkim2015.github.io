...
**Q1. 시스템 디자인 면접에서 요구사항 분석을 먼저 해야 하는 이유는?**
...
**Q2. 수직 확장과 수평 확장의 전환 시점을 어떻게 판단하는가?**
...
**Q3. 캐시와 DB의 정합성 문제를 면접에서 어떻게 설명하는가?**
...
**Q4. 메시지 큐 없이 대용량 시스템을 운영하면 어떤 문제가 생기는가?**
...
**Q5. CAP 정리를 실제 시스템 선택에 적용하는 방법은?**
